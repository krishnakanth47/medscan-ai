...
# ROOT HOMEPAGE (this fixes your "Not Found" issue)
...
async def home():
    ...
    <html>
        ...
        <body style="font-family: Arial; text-align: center; margin-top: 50px;">
            <h1>MedScan AI is Running ✅</h1>
            <p>Your backend is deployed successfully on Render.</p>
            <p>
...
async def upload_report(file: UploadFile = File(...)):
    ...
    return {
        ...
        "message": "File uploaded successfully. Call POST /analyze/{report_id}"
    }
...
async def download_pdf(report_id: int):
    ...
    if report.get("status") != "analyzed":
        raise HTTPException(
            status_code=400,
            detail="Report has not been analysed yet."
        )
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition":
            f'attachment; filename="medscan_report_{report_id}.pdf"'
        },
    )
