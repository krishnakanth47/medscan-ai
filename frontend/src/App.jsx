    ...
    <header className="border-b border-slate-800 bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ filter: 'drop-shadow(0 0 6px rgba(59,130,246,0.5))' }}>
            {/* Brain outline */}
            <path d="M19 5C13 5 8 9.5 8 15.5C8 18.5 9.2 21.2 11.2 23.2L11 30H27L26.8 23.2C28.8 21.2 30 18.5 30 15.5C30 9.5 25 5 19 5Z" fill="url(#brainGrad)" opacity="0.9"/>
            {/* Circuit nodes */}
            ...
            {/* Stethoscope arc */}
            <path d="M11 16 Q9 20 11 24" stroke="#1D4ED8" strokeWidth="1.8" fill="none" strokeLinecap="round"/>
            <circle cx="11" cy="24.5" r="1.5" fill="#3B82F6"/>
            {/* Magnifier */}
            <circle cx="21" cy="22" r="4" stroke="#1E3A8A" strokeWidth="1.5" fill="#DBEAFE" opacity="0.35"/>
            <line x1="24" y1="25" x2="27" y2="28" stroke="#1E3A8A" strokeWidth="1.8" strokeLinecap="round"/>
            {/* Bottom platform */}
            <rect x="11" y="29.5" width="16" height="3" rx="1.5" fill="url(#baseGrad)"/>
            <defs>
              <linearGradient id="brainGrad" x1="8" y1="5" x2="30" y2="30" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#1D4ED8"/>
                <stop offset="100%" stopColor="#0EA5E9"/>
              </linearGradient>
              <linearGradient id="baseGrad" x1="11" y1="29" x2="27" y2="32" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#1D4ED8"/>
          ...
          <div>
            <span className="font-bold text-white text-lg tracking-tight">MedScan</span>
